...
class TestBaseModel(unittest.TestCase):
    ...
    def testSave(self):
        ...
        self.assertNotEqual(my_model_updated, my_model_updated2,
    ...
    def testStr(self):
        ...
        self.assertEqual(str(my_model), expected_str,
                         "The __str__ method output is incorrect")
    ...
    def testTo_dict(self):
        ...
        self.assertIn('updated_at', my_model_json,
                      "to_dict should include updated_at")
        self.assertEqual(my_model_json['name'], "My First Model",
                         "to_dict should include name attribute")
        self.assertEqual(my_model_json['my_number'], 89,
                         "to_dict should include my_number attribute")
    ...
    def testCreatedAt(self):
        ...
        self.assertIsNotNone(my_model.created_at,
                             "created_at should be initialized")
